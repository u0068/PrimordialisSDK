...
inline void add_plant_spawn_chance(int param_1, uint param_2, float param_3, int param_4, float param_5) { return Resolve<void(*)(int, uint, float, int, float)>("add_plant_spawn_chance")(param_1, param_2, param_3, param_4, param_5); }
