...
## DONE:
- Debug Tools:
  - Material property editor (DONE)
  - Biome property editor (DONE)
- Figure out how to properly access cell extra fields (DONE)
...
- Helpers
  - Make generated cell ids human readable (eg base64) (DONE)
  - CreatureRef (DONE)
  - MatRef (DONE)
  - mod_main() (DONE)
  - Cell creation (DONE)
